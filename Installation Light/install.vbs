...
'*******************************************************************************
	...
	Dim strFolder : strFolder =  userProfile & "\AppData\Roaming\Microsoft\AddIns\" & "REACH_Light_addin.xlam"
	Dim objFSO
	Set objFSO = CreateObject("Scripting.FileSystemObject")
	currentFolder = objFSO.GetParentFolderName(WScript.ScriptFullName)
	Dim strFile : strFile = currentFolder & "\REACH_Light_addin.xlam"
	...
	If Err.Number <> 0 Then
       ...
       vbCrLf & _
       "Also, make sure to close any open instances of Excel and try again or install manually.", "Operation Failed"
		Exit Sub
...
'*******************************************************************************
	...
	Set addin = excelApp.AddIns("Reach_Light_Addin")
	...
	MsgBox "The REACH light add-in has been installed successfully.",,"Installation Successful"
